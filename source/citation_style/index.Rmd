...
Hiervan is een [issue](https://github.com/retorquere/zotero-better-bibtex/issues/1601) gemaakt bij Better BibTeX.

### Export van article met page-range 'x-y'

Range `x-y` wordt omgezet naar `x--y` (in bib-file).

Zie aangemaakt [issue](https://github.com/retorquere/zotero-better-bibtex/issues/1602).
