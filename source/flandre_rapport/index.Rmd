...
author:
  - name:
    ...
    affiliation: Institut de Recherche sur la Nature et les Forêts (INBO)
    corresponding: true
  - name:
      given: Els
      family: Lommelen
...
funder:
  - name:
      given: Institut de Recherche sur la Nature et les Forêts (INBO)
    email: info@inbo.be
...
publisher: Institut de Recherche sur la Nature et les Forêts (INBO)
