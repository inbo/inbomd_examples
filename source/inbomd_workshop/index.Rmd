...
- Example code using `INBOmd` 
    ...
    - Do have a look at our [tips and tricks for the pdf version](https://inbomd-examples.netlify.com/inbo_rapport/13-lay-out-tips-voor-pdf.html)
...
- Enter the `name` for your report, select its main directory and press 'OK'
    - This creates `name/name.Rmd` in the selected directory
    - Rename `name/name.Rmd` to `name/index.Rmd` in the `Files` window of RStudio
...
- `[@bibtex-key]` for the notation with parantheses [@Agresti2002]
- `@bibtex-key` for the notation without parantheses @Amano2012
