...
- INBOtheme:
  - [Color palettes](https://github.com/inbo/INBOtheme), [see Tutorials](https://inbo.github.io/INBOtheme/articles/index.html)
...
- select the subset with `selection <- iris %>% filter(Species == params$species)`
- take care to make your text and code dynamic such that it can accommodate different data.
