...
publication_type: publication-other
community: inbo
...
install.packages(
  "INBOmd",
  repos = c("https://inbo.r-universe.dev", getOption("repos"))
)
...
for (id in todo) {
  rmarkdown::render(
    input = "_iris_template_separate_reports.Rmd",
    output_format = "bookdown::pdf_document2",
    params = list(species = id),
    output_file = rprojroot::find_root_file(
      "output",
