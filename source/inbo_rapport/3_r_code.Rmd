...
random_zin <- function(n_woorden = 10, n_letters = 10) {
  paste(
    sapply(rpois(n_woorden, n_letters), FUN = random_woord),
    collapse = " "
  )
}
...
Dit gedraagt zich als het `longtable` formaat met een aangepaste layout.
...
De `booktabs` optie past een layout met minder lijnen toe (tabel \@ref(tab:kable-booktabs)).
