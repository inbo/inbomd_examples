...
Het longtable formaat is geschikt wanneer we een tabel hebben die langer is dan een pagina (tabel \@ref(tab:kable-longtable)). Dit soort tabel is geen floating table. Dat wil zeggen dat ze onmiddellijk start daar waar de code ze genereert. Onderaan de pagina wordt de tabel afgebroken en op de volgende pagina opnieuw gestart. Merk op dat een te brede tabel nog steeds wordt afgebroken.
