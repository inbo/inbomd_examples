...
```{r movie, fig.cap= "Verdeling aandeel slokdarmkander in Ille-et-Villaine, Frankrijk i.f.v. de leeftijdsgroep.", message = FALSE}
ggplot(esoph, aes(x = ncases / (ncases + ncontrols))) + 
  geom_histogram() + 
  facet_wrap(~agegp, scales = "free")
```

```{r diamond, fig.cap= "Histrogram van de diamantprijs i.f.v. van kwaliteit van het slijpwerk.", message = FALSE, fig.width = 6, fig.height = 4}
