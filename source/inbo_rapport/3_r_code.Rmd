...
Het longtable formaat is beschikt wanneer we een tabel hebben die langer is dan op een pagina past (tabel \@ref(tab:kable-longtable)). Dit soort tabel is geen floating table. Dat wil zeggen dat ze onmiddellijk start daar waar de code ze genereert. Onderaan de pagina wordt de tabel afgebroken en op de volgende pagina opnieuw gestart. Merk op dit een te brede tabel nog steeds wordt afgebroken.
...
Het markdown formaat is handig voor grotere tabellen met tekst. Wanneer de tekst te lang is worden de rijen over meerdere regels gespreidt. Indien nodig wordt de tabel over meerdere pagina's gespreidt. Het nadeel is dat je geen bijschrift kan plaatsen en er ook niet naar kan verwijzen.
...
1. Kruisverwijzingen zijn lastig, zeker als je ze wel in pdf als HTML wilt hebben.
